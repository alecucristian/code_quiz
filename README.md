...
- **Classic 8-Bit Arcade Aesthetics**:
  ...
  - Authentic CRT screen scanlines overlay with a live `📺` toggle button.
...
- **Scalable Multi-Deck Library (5 Built-in Decks / 566 Questions)**:
  ...
  - 🧠 **Senior SWE Lexicon & Acronyms (80 Qs)**: Curated terms, acronyms, laws, and system design patterns every Senior/Staff Engineer should know: CAP/PACELC, Saga & 2PC, CQRS & Event Sourcing, Idempotency, Backpressure, Circuit Breakers, Outbox Pattern, CDC, SRE (SLI/SLO/SLA, Error Budgets, Four Golden Signals, USE vs RED, Cascading Failures, MTTR), Engineering Laws (Conway's Law, Hyrum's Law, Chesterton's Fence, Gall's Law, Brooks' Law, SOLID, DRY/WET/AHA, Strangler Fig), Security (OAuth 2.0/OIDC, PKCE, mTLS, Zero Trust, PoLP, CORS, XSS/CSRF, SSRF, ReDoS), Concurrency & Storage (ACID vs BASE, MVCC, SSI Write Skew, LSM-Trees vs B-Trees, Bloom Filters, OCC vs PCC, CAS), and Delivery Strategy (DORA Metrics, ADRs, RFCs, Trunk-Based Development, Feature Flags, Blast Radius, Dark Launching).
...
| **Toggle Audio (Mute)** | Click `🔊` in the top header |
| **Toggle Scanlines** | Click `📺` in the top header |
